...
public class OwnerQuery extends JFrame{
	...
	public JTextField onamef = new JTextField("");//то есть вводится имя собаки и получаем данные о ее хозяине
	
	JLabel label2 = new JLabel("Выбрать телефонный номер хозяина собаки по имени:  ");
	public JTextField ophonef = new JTextField("");
	
	JLabel label3 = new JLabel("Выбрать часы прогулок хозяина с собакой по имени: ");
	...
	class btnTimeListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			try {
				...
				JOptionPane.showMessageDialog(null,res,"Часы прогулок собаки" + name +':',JOptionPane.PLAIN_MESSAGE);
			} catch (SQLException e1) {
				e1.printStackTrace();
			}
